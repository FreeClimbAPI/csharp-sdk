...
namespace freeclimb_cs_sdk_test.api.call
{
    ...
    public class OutboundCallTest
    {
        ...
        {
            string json = "{\"to\":\"+18475978014\",\"from\":\"+12248806205\",\"callConnectUrl\":\"http://foo.com/FreeClimb/RecordingCallAnswered\",\"timeout\":27,\"ifMachine\":\"continue\"}";
        ...
        public void MakeOutboundCallToJsonTest()
        {
            ...
            call.setCallConnectUrl("http://foo.com/FreeClimb/RecordingCallAnswered");

            string json = call.toJson();

            Assert.IsNotNull(json);
            Assert.AreEqual(json, "{\"to\":\"+18475978014\",\"from\":\"+12248806205\",\"callConnectUrl\":\"http://foo.com/FreeClimb/RecordingCallAnswered\"}");
        }
    }
}

...
namespace com.freeclimb.api.phonenumber
{
    ...
    public class AvailablePhoneNumbersRequester : APIRequester
    {
        ...
        public AvailablePhoneNumbersRequester(string credAccountId, string credApiKey, string accountId) : base(credAccountId, credApiKey)
        {
        ...
        public AvailablePhoneNumberList get(AvailablePhoneNumbersSearchFilter filters = null)
        {
            ...
            AvailablePhoneNumberList list = new AvailablePhoneNumberList(this.getAccountId, this.getApiKey, json);

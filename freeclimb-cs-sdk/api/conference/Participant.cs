...
{
    /// <summary>
    /// This class represents a FreeClimb Participant instance. Participant objects are created
    /// by the SDK whenever a participant instance would be returned by the API; these
    /// primarily come from ConferencesRequester inside a FreeClimbClient instance.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    [JsonObject]
    public sealed class Participant : FreeClimbCommon, IEquatable<Participant>
    {

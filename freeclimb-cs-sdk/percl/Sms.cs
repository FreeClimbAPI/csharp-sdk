...
namespace com.freeclimb.percl
{
    ...
    public sealed class Sms : PerCLCommand
    {
        ...
        public override IDictionary<string, object> toKvp()
        {
            ...
            {
                throw new FreeClimbJSONException("from is a required parameter");
            }
            props.Add("from", getFrom);
            if (String.IsNullOrEmpty(getTo) == true)
            {
                throw new FreeClimbJSONException("to is a required parameter");
            }
            props.Add("to", getTo);
            if (String.IsNullOrEmpty(getText) == true)
            {
                throw new FreeClimbJSONException("text is a required parameter");
            }

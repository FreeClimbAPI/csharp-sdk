...
using com.persephony.webhooks.application;
using com.persephony;

namespace persy_cs_sdk_test.webhooks.application
{
    [TestClass]
    public class ApplicationVoiceCallbackTest
    {
        [TestMethod]
        public void CreateAndVerifyApplicationCallbackTest()
        {
            ApplicationVoiceCallback pr = ApplicationVoiceCallback.fromJson("{ \"accountId\": \"ACae05391ecca1352e9108d545482a1e6f384e7a49\", \"callId\": \"CAbde0362aef3d228b3a39baafa9e4f0204e724966\", \"callStatus\": \"ringing\", \"conferenceId\": null, \"direction\": \"inbound\", \"from\": \"+17083168669\", \"parentCallId\": null, \"queueId\": null, \"requestId\": \"RQ0c74d2e880709c85e8a4e3093b85b910eee4110b\", \"requestType\": \"inboundCall\", \"to\": \"+12248806211\" }");

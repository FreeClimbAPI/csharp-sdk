...
**DateCreatedISO** | **DateTime?** | The date that this resource was created in ISO 8601 format (e.g., 2022-01-01T00:00:00.000Z). | [optional] 
**DateUpdatedISO** | **DateTime?** | The date that this resource was last updated in ISO 8601 format (e.g., 2022-01-01T00:00:00.000Z). | [optional] 
...
**StartTimeISO** | **DateTime?** | Start time of the Call in ISO 8601 format (e.g., 2022-01-01T00:00:00.000Z). Empty if the Call has not yet been dialed. | [optional] 
...
**ConnectTimeISO** | **DateTime?** | Time the Call was answered in ISO 8601 format (e.g., 2022-01-01T00:00:00.000Z). Empty if the Call has not yet been dialed. | [optional] 
...
**EndTimeISO** | **DateTime?** | End time of the Call in ISO 8601 format (e.g., 2022-01-01T00:00:00.000Z). Empty if the Call did not complete successfully. | [optional] 
...
**WebRTC** | **bool?** | Indicates whether this Call was initiated via WebRTC. | [optional] 

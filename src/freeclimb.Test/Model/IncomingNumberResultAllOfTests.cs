...
namespace freeclimb.Test.Model
{
    ...
    public class IncomingNumberResultAllOfTests : IDisposable
    {
        ...
        {
            instance = new IncomingNumberResultAllOf(new Capabilities(true, true, true, true, true), "TEST_STRING", "TEST_STRING", "TEST_STRING", "TEST_STRING", "TEST_STRING", "TEST_STRING", "TEST_STRING", "TEST_STRING", false, false, false);
        }

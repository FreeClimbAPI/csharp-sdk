...
namespace freeclimb.Test.Model
{
    ...
    public class SMSTollFreeCampaignTests : IDisposable
    {
        ...
        public void RegistrationStatusTest()
        {
            ...
            Assert.Equal(SMSTollFreeCampaignRegistrationStatus.UNREGISTERED, instance.RegistrationStatus);
            instance.RegistrationStatus = SMSTollFreeCampaignRegistrationStatus.INITIATED;
            Assert.Equal(SMSTollFreeCampaignRegistrationStatus.INITIATED, instance.RegistrationStatus);
            instance.RegistrationStatus = SMSTollFreeCampaignRegistrationStatus.PENDING;
            Assert.Equal(SMSTollFreeCampaignRegistrationStatus.PENDING, instance.RegistrationStatus);
            instance.RegistrationStatus = SMSTollFreeCampaignRegistrationStatus.DECLINED;
            Assert.Equal(SMSTollFreeCampaignRegistrationStatus.DECLINED, instance.RegistrationStatus);
            instance.RegistrationStatus = SMSTollFreeCampaignRegistrationStatus.REGISTERED;
            Assert.Equal(SMSTollFreeCampaignRegistrationStatus.REGISTERED, instance.RegistrationStatus);

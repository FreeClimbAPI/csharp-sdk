...
namespace freeclimb.Test.Api
{
    ...
    public class DefaultApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test GetAnSmsTenDLCBrands
        /// </summary>
        [Fact]

        public void GetAnSmsTenDLCBrandsTest()
        {

            var response = instance.GetAnSmsTenDLCBrands();
            //Assert.IsType<SMSTenDLCBrandsListResult>(response);
            Assert.IsAssignableFrom<SMSTenDLCBrandsListResult>(response);
        }

        /// <summary>
        /// Test GetAnSmsTenDLCCampaigns
        /// </summary>
        [Fact]

        public void GetAnSmsTenDLCCampaignsTest()
        {

            string brandId = brandIdTestValue();

            var response = instance.GetAnSmsTenDLCCampaigns(brandId);
            //Assert.IsType<SMSTenDLCCampaignsListResult>(response);
            Assert.IsAssignableFrom<SMSTenDLCCampaignsListResult>(response);
        }

        /// <summary>
        /// Test GetAnSmsTenDLCPartnerCampaigns
        /// </summary>
        [Fact]

        public void GetAnSmsTenDLCPartnerCampaignsTest()
        {

            string brandId = brandIdTestValue();

            var response = instance.GetAnSmsTenDLCPartnerCampaigns(brandId);

...
namespace freeclimb.Test.Enums
{
    ...
    public class MessageStatusTests : IDisposable
    {
        ...
        {
            instance = MessageStatusInstanceValue();
        }
        ...
        {
            string expectedValue = StringValueMessageStatusTestValue();
        ...
        {
            string expectedValue = StringValueMessageStatusTestValue();
            MessageStatus calculatedValue = Reflection.GetEnumByValue<MessageStatus>(expectedValue);
            Assert.Equal(instance, calculatedValue);
        }
        private MessageStatus MessageStatusInstanceValue()
        {
            return Reflection.GetEnumByValue<MessageStatus>(StringValueMessageStatusTestValue());
        }

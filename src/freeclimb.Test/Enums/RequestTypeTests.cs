...
namespace freeclimb.Test.Enums
{
    ...
    public class RequestTypeTests : IDisposable
    {
        ...
        {
            instance = RequestTypeInstanceValue();
        }
        ...
        {
            string expectedValue = StringValueRequestTypeTestValue();
        ...
        {
            string expectedValue = StringValueRequestTypeTestValue();
            RequestType calculatedValue = Reflection.GetEnumByValue<RequestType>(expectedValue);
            Assert.Equal(instance, calculatedValue);
        }
        private RequestType RequestTypeInstanceValue()
        {
            return Reflection.GetEnumByValue<RequestType>(StringValueRequestTypeTestValue());
        }

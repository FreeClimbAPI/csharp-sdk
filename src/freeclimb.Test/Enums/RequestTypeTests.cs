...
namespace freeclimb.Test.Enums
{
    ...
    public class RequestTypeTests
    {
        ...
        public void TestINBOUND_CALLShouldSerializeToEnum()
        {
            ...
            RequestType calculatedValue = (RequestType)Enum.Parse(typeof(RequestType), "INBOUND_CALL");
        ...
        public void TestGET_DIGITSShouldSerializeToEnum()
        {
            ...
            RequestType calculatedValue = (RequestType)Enum.Parse(typeof(RequestType), "GET_DIGITS");
            Assert.Equal(expectedValue, calculatedValue);
        }
        ...
        public void TestGET_SPEECHShouldSerializeToEnum()
        {
            ...
            RequestType calculatedValue = (RequestType)Enum.Parse(typeof(RequestType), "GET_SPEECH");
            Assert.Equal(expectedValue, calculatedValue);
        }
        ...
        public void TestOUT_DIAL_STARTShouldSerializeToEnum()
        {
            ...
            RequestType calculatedValue = (RequestType)Enum.Parse(typeof(RequestType), "OUT_DIAL_START");
            Assert.Equal(expectedValue, calculatedValue);
        }
        ...
        public void TestOUT_DIAL_CONNECTShouldSerializeToEnum()
        {
            ...
            RequestType calculatedValue = (RequestType)Enum.Parse(typeof(RequestType), "OUT_DIAL_CONNECT");
            Assert.Equal(expectedValue, calculatedValue);
        }
        ...
        public void TestOUT_DIAL_API_CONNECTShouldSerializeToEnum()
        {
            ...
            RequestType calculatedValue = (RequestType)Enum.Parse(typeof(RequestType), "OUT_DIAL_API_CONNECT");
            Assert.Equal(expectedValue, calculatedValue);
        }
        ...
        public void TestMACHINE_DETECTEDShouldSerializeToEnum()
        {
            ...
            RequestType calculatedValue = (RequestType)Enum.Parse(typeof(RequestType), "MACHINE_DETECTED");
            Assert.Equal(expectedValue, calculatedValue);
        }
        ...
        public void TestQUEUE_WAITShouldSerializeToEnum()
        {
            ...
            RequestType calculatedValue = (RequestType)Enum.Parse(typeof(RequestType), "QUEUE_WAIT");
            Assert.Equal(expectedValue, calculatedValue);
        }
        ...
        public void TestADD_TO_QUEUE_NOTIFICATIONShouldSerializeToEnum()
        {
            ...
            RequestType calculatedValue = (RequestType)Enum.Parse(typeof(RequestType), "ADD_TO_QUEUE_NOTIFICATION");
            Assert.Equal(expectedValue, calculatedValue);
        }
        ...
        public void TestCALL_STATUSShouldSerializeToEnum()
        {
            ...
            RequestType calculatedValue = (RequestType)Enum.Parse(typeof(RequestType), "CALL_STATUS");
            Assert.Equal(expectedValue, calculatedValue);
        }
        ...
        public void TestCREATE_CONFERENCEShouldSerializeToEnum()
        {
            ...
            RequestType calculatedValue = (RequestType)Enum.Parse(typeof(RequestType), "CREATE_CONFERENCE");
            Assert.Equal(expectedValue, calculatedValue);
        }
        ...
        public void TestCONFERENCE_STATUSShouldSerializeToEnum()
        {
            ...
            RequestType calculatedValue = (RequestType)Enum.Parse(typeof(RequestType), "CONFERENCE_STATUS");
            Assert.Equal(expectedValue, calculatedValue);
        }
        ...
        public void TestLEAVE_CONFERENCEShouldSerializeToEnum()
        {
            ...
            RequestType calculatedValue = (RequestType)Enum.Parse(typeof(RequestType), "LEAVE_CONFERENCE");
            Assert.Equal(expectedValue, calculatedValue);
        }
        ...
        public void TestADD_TO_CONFERENCE_NOTIFICATIONShouldSerializeToEnum()
        {
            ...
            RequestType calculatedValue = (RequestType)Enum.Parse(typeof(RequestType), "ADD_TO_CONFERENCE_NOTIFICATION");
            Assert.Equal(expectedValue, calculatedValue);
        }
        ...
        public void TestCONFERENCE_RECORDING_STATUSShouldSerializeToEnum()
        {
            ...
            RequestType calculatedValue = (RequestType)Enum.Parse(typeof(RequestType), "CONFERENCE_RECORDING_STATUS");
            Assert.Equal(expectedValue, calculatedValue);
        }
        ...
        public void TestCONFERENCE_CALL_CONTROLShouldSerializeToEnum()
        {
            ...
            RequestType calculatedValue = (RequestType)Enum.Parse(typeof(RequestType), "CONFERENCE_CALL_CONTROL");
            Assert.Equal(expectedValue, calculatedValue);
        }
        ...
        public void TestMESSAGE_DELIVERYShouldSerializeToEnum()
        {
            ...
            RequestType calculatedValue = (RequestType)Enum.Parse(typeof(RequestType), "MESSAGE_DELIVERY");
            Assert.Equal(expectedValue, calculatedValue);
        }
        ...
        public void TestMESSAGE_STATUSShouldSerializeToEnum()
        {
            ...
            RequestType calculatedValue = (RequestType)Enum.Parse(typeof(RequestType), "MESSAGE_STATUS");
            Assert.Equal(expectedValue, calculatedValue);
        }

...
namespace freeclimb.Test.Enums
{
    ...
    public class LogLevelTests : IDisposable
    {
        ...
        {
            instance = LogLevelInstanceValue();
        }
        ...
        {
            string expectedValue = StringValueLogLevelTestValue();
        ...
        {
            string expectedValue = StringValueLogLevelTestValue();
            LogLevel calculatedValue = Reflection.GetEnumByValue<LogLevel>(expectedValue);
            Assert.Equal(instance, calculatedValue);
        }
        private LogLevel LogLevelInstanceValue()
        {
            return Reflection.GetEnumByValue<LogLevel>(StringValueLogLevelTestValue());
        }

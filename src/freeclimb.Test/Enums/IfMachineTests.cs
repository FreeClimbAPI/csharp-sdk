...
namespace freeclimb.Test.Enums
{
    ...
    public class IfMachineTests : IDisposable
    {
        ...
        {
            instance = IfMachineInstanceValue();
        }
        ...
        {
            // TODO uncomment below to test "IsType" IfMachine
        ...
        {
            string expectedValue = StringValueIfMachineTestValue();
        ...
        {
            string expectedValue = StringValueIfMachineTestValue();
            IfMachine calculatedValue = Reflection.GetEnumByValue<IfMachine>(expectedValue);
            Assert.Equal(instance, calculatedValue);
        }
        private IfMachine IfMachineInstanceValue()
        {
            return Reflection.GetEnumByValue<IfMachine>(StringValueIfMachineTestValue());
        }

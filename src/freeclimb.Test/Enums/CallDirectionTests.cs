...
namespace freeclimb.Test.Enums
{
    ...
    public class CallDirectionTests : IDisposable
    {
        ...
        {
            instance = CallDirectionInstanceValue();
        }
        ...
        {
            string expectedValue = StringValueCallDirectionTestValue();
        ...
        {
            string expectedValue = StringValueCallDirectionTestValue();
            CallDirection calculatedValue = Reflection.GetEnumByValue<CallDirection>(expectedValue);
            Assert.Equal(instance, calculatedValue);
        }
        private CallDirection CallDirectionInstanceValue()
        {
            return Reflection.GetEnumByValue<CallDirection>(StringValueCallDirectionTestValue());
        }

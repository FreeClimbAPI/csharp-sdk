...
namespace freeclimb.Test.Enums
{
    ...
    public class MessageDirectionTests : IDisposable
    {
        ...
        {
            instance = MessageDirectionInstanceValue();
        }
        ...
        {
            string expectedValue = StringValueMessageDirectionTestValue();
            MessageDirection calculatedValue = Reflection.GetEnumByValue<MessageDirection>(expectedValue);
            Assert.Equal(instance, calculatedValue);
        }
        private MessageDirection MessageDirectionInstanceValue()
        {
            return Reflection.GetEnumByValue<MessageDirection>(StringValueMessageDirectionTestValue());
        }

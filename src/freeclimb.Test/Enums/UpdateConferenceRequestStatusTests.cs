...
namespace freeclimb.Test.Enums
{
    ...
    public class UpdateConferenceRequestStatusTests : IDisposable
    {
        ...
        {
            instance = UpdateConferenceRequestStatusInstanceValue();
        }
        ...
        {
            string expectedValue = StringValueUpdateConferenceRequestStatusTestValue();
        ...
        {
            string expectedValue = StringValueUpdateConferenceRequestStatusTestValue();
            UpdateConferenceRequestStatus calculatedValue = Reflection.GetEnumByValue<UpdateConferenceRequestStatus>(expectedValue);
            Assert.Equal(instance, calculatedValue);
        }
        private UpdateConferenceRequestStatus UpdateConferenceRequestStatusInstanceValue()
        {
            return Reflection.GetEnumByValue<UpdateConferenceRequestStatus>(StringValueUpdateConferenceRequestStatusTestValue());
        }

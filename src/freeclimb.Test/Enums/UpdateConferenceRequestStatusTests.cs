...
{
    /// <summary>
    ///  Class for testing UpdateConferenceRequestStatus
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the model.
    /// </remarks>
    public class UpdateConferenceRequestStatusTests : IDisposable
    {
        // TODO uncomment below to declare an instance variable for UpdateConferenceRequestStatus
        private UpdateConferenceRequestStatus instance;
        ...
        /// <summary>
        /// Test an instance of UpdateConferenceRequestStatus
        /// </summary>
        [Fact]
        public void UpdateConferenceRequestStatusInstanceTest()
        {
            Assert.IsType<UpdateConferenceRequestStatus>(instance);
        }
        ...
        public void TestEMPTYShouldWork()
        {
            ...
            Assert.Equal(typeof(UpdateConferenceRequestStatus), test.GetType());
        }

        [Fact]
        public void TestEMPTYShouldSerializeToEnum()
        {
            UpdateConferenceRequestStatus expectedValue = UpdateConferenceRequestStatus.EMPTY;
            UpdateConferenceRequestStatus calculatedValue = (UpdateConferenceRequestStatus)Enum.Parse(typeof(UpdateConferenceRequestStatus), "EMPTY");
        ...
        {
            UpdateConferenceRequestStatus expectedValue = UpdateConferenceRequestStatus.TERMINATED;
            UpdateConferenceRequestStatus calculatedValue = (UpdateConferenceRequestStatus)Enum.Parse(typeof(UpdateConferenceRequestStatus), "TERMINATED");
            Assert.Equal(expectedValue, calculatedValue);
        }

...
namespace freeclimb.Test.Enums
{
    ...
    /// </remarks>
    public class CallStatusTests : IDisposable
    {
        // TODO uncomment below to declare an instance variable for CallStatus
        private CallStatus instance;

        public CallStatusTests()
        {
            instance = CallStatusInstanceValue();
        }
        ...
        {
            // TODO uncomment below to test "IsType" CallStatus
        ...
        {
            string expectedValue = StringValueCallStatusTestValue();
        ...
        {
            string expectedValue = StringValueCallStatusTestValue();
            CallStatus calculatedValue = Reflection.GetEnumByValue<CallStatus>(expectedValue);
            Assert.Equal(instance, calculatedValue);
        }
        private CallStatus CallStatusInstanceValue()
        {
            return Reflection.GetEnumByValue<CallStatus>(StringValueCallStatusTestValue());
        }

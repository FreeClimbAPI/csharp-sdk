...
namespace freeclimb.Test.Enums
{
    ...
    public class QueueResultStatusTests : IDisposable
    {
        ...
        {
            instance = QueueResultStatusInstanceValue();
        }
        ...
        {
            // TODO uncomment below to test "IsType" QueueResultStatus
        ...
        {
            string expectedValue = StringValueQueueResultStatusTestValue();
            QueueResultStatus calculatedValue = Reflection.GetEnumByValue<QueueResultStatus>(expectedValue);
            Assert.Equal(instance, calculatedValue);
        }
        private QueueResultStatus QueueResultStatusInstanceValue()
        {
            return Reflection.GetEnumByValue<QueueResultStatus>(StringValueQueueResultStatusTestValue());
        }

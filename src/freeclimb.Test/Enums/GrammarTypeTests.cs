...
namespace freeclimb.Test.Enums
{
    ...
    public class GrammarTypeTests : IDisposable
    {
        ...
        {
            instance = GrammarTypeInstanceValue();
        }
        ...
        {
            // TODO uncomment below to test "IsType" GrammarType
        ...
        {
            string expectedValue = StringValueGrammarTypeTestValue();
            GrammarType calculatedValue = Reflection.GetEnumByValue<GrammarType>(expectedValue);
            Assert.Equal(instance, calculatedValue);
        }
        private GrammarType GrammarTypeInstanceValue()
        {
            return Reflection.GetEnumByValue<GrammarType>(StringValueGrammarTypeTestValue());
        }

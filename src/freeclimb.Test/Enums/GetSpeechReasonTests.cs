...
namespace freeclimb.Test.Enums
{
    ...
    public class GetSpeechReasonTests : IDisposable
    {
        ...
        {
            instance = GetSpeechReasonInstanceValue();
        }
        ...
        {
            string expectedValue = StringValueGetSpeechReasonTestValue();
        ...
        {
            string expectedValue = StringValueGetSpeechReasonTestValue();
            GetSpeechReason calculatedValue = Reflection.GetEnumByValue<GetSpeechReason>(expectedValue);
            Assert.Equal(instance, calculatedValue);
        }
        private GetSpeechReason GetSpeechReasonInstanceValue()
        {
            return Reflection.GetEnumByValue<GetSpeechReason>(StringValueGetSpeechReasonTestValue());
        }

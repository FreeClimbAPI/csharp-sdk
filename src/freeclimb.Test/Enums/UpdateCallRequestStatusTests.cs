...
{
    /// <summary>
    ///  Class for testing UpdateCallRequestStatus
    /// </summary>
    /// <remarks>
    ...
    public class UpdateCallRequestStatusTests : IDisposable
    {
        ...
        {
            instance = UpdateCallRequestStatusInstanceValue();
        }
        ...
        /// <summary>
        /// Test an instance of UpdateCallRequestStatus
        /// </summary>
        [Fact]
        public void UpdateCallRequestStatusInstanceTest()
        {
            // TODO uncomment below to test "IsType" UpdateCallRequestStatus
            //Assert.IsType<UpdateCallRequestStatus>(instance);
        }
        ...
        {
            string expectedValue = StringValueUpdateCallRequestStatusTestValue();
        ...
        {
            string expectedValue = StringValueUpdateCallRequestStatusTestValue();
            UpdateCallRequestStatus calculatedValue = Reflection.GetEnumByValue<UpdateCallRequestStatus>(expectedValue);
            Assert.Equal(instance, calculatedValue);
        }
        private UpdateCallRequestStatus UpdateCallRequestStatusInstanceValue()
        {
            return Reflection.GetEnumByValue<UpdateCallRequestStatus>(StringValueUpdateCallRequestStatusTestValue());
        }

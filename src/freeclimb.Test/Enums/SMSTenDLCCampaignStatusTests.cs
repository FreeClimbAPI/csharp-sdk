...
namespace freeclimb.Test.Enums
{
    ...
    public class SMSTenDLCCampaignStatusTests : IDisposable
    {
        ...
        public void TestACTIVEShouldSerializeToEnum()
        {
            ...
            SMSTenDLCCampaignStatus calculatedValue = (SMSTenDLCCampaignStatus)Enum.Parse(typeof(SMSTenDLCCampaignStatus), "ACTIVE");
        ...
        public void TestEXPIREDShouldSerializeToEnum()
        {
            ...
            SMSTenDLCCampaignStatus calculatedValue = (SMSTenDLCCampaignStatus)Enum.Parse(typeof(SMSTenDLCCampaignStatus), "EXPIRED");
            Assert.Equal(expectedValue, calculatedValue);
        }

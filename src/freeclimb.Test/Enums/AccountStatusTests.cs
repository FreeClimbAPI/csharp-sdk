...
namespace freeclimb.Test.Enums
{
    ...
    public class AccountStatusTests : IDisposable
    {
        ...
        {
            instance = AccountStatusInstanceValue();
        }
        ...
        private AccountStatus AccountStatusInstanceValue()
        {
            return Reflection.GetEnumByValue<AccountStatus>(StringValueAccountStatusTestValue());
        }

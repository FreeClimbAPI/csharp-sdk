...
namespace freeclimb.Test.Enums
{
    ...
    public class BargeInReasonTests : IDisposable
    {
        ...
        public void TestNO_BARGE_INShouldSerializeToEnum()
        {
            ...
            BargeInReason calculatedValue = (BargeInReason)Enum.Parse(typeof(BargeInReason), "NO_BARGE_IN");
        ...
        public void TestBARGE_IN_BY_DTMFShouldSerializeToEnum()
        {
            ...
            BargeInReason calculatedValue = (BargeInReason)Enum.Parse(typeof(BargeInReason), "BARGE_IN_BY_DTMF");
            Assert.Equal(expectedValue, calculatedValue);
        }
        ...
        public void TestBARGE_IN_BY_ENERGYShouldSerializeToEnum()
        {
            ...
            BargeInReason calculatedValue = (BargeInReason)Enum.Parse(typeof(BargeInReason), "BARGE_IN_BY_ENERGY");
            Assert.Equal(expectedValue, calculatedValue);
        }

...
namespace freeclimb.Test.Enums
{
    ...
    public class GrammarFileBuiltInTests : IDisposable
    {
        ...
        {
            instance = GrammarFileBuiltInInstanceValue();
        }
        ...
        {
            // TODO uncomment below to test "IsType" GrammarFileBuiltIn
        ...
        {
            string expectedValue = StringValueGrammarFileBuiltInTestValue();
        ...
        {
            string expectedValue = StringValueGrammarFileBuiltInTestValue();
            GrammarFileBuiltIn calculatedValue = Reflection.GetEnumByValue<GrammarFileBuiltIn>(expectedValue);
            Assert.Equal(instance, calculatedValue);
        }
        private GrammarFileBuiltIn GrammarFileBuiltInInstanceValue()
        {
            return Reflection.GetEnumByValue<GrammarFileBuiltIn>(StringValueGrammarFileBuiltInTestValue());
        }

...
namespace freeclimb.Model
{
    ...
    public partial class AvailableNumber : IEquatable<AvailableNumber>, IValidatableObject
    {
        ...
        public AvailableNumber(Capabilities capabilities = default(Capabilities), string campaignId = default(string), SmsProviderEnum? smsProvider = default(SmsProviderEnum?), string phoneNumber = default(string), bool? voiceEnabled = default(bool?), bool? smsEnabled = default(bool?), string region = default(string), string country = default(string))
        {

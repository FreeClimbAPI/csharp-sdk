...
namespace freeclimb.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SayClassic")]
    public partial class SayClassic : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SayClassic" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SayClassic() { }
        ...
        )
        {
            ...
            if (text == null)
            {
                throw new ArgumentNullException(
                    "text is a required property for SayClassic and cannot be null"
                );
            }
            this.Text = text;
        ...
        /// <summary>
        /// Retrieve the KVP Dictionary for the SayClassic instance.
        /// </summary>

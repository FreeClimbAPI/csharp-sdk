...
namespace freeclimb.Model
{
    ...
    public partial class QueueList : IValidatableObject, IPagination
    {
        ...
        public QueueList(
            ...
            List<QueueResult> queues = default(List<QueueResult>)
        )
        {
            this.Total = total;
        ...
        public virtual IDictionary<string, object> ToKvp()
        {
            ...
            List<object> nestedQueues = new List<object>();
            if (Queues != null)
            {
                foreach (var item in Queues)
                {
                    nestedQueues.Add(item.ToKvp());
                }
            }
            AddToDictionary(props, "queues", nestedQueues);
            return props;
        }

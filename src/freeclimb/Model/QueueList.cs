...
namespace freeclimb.Model
{
    ...
    public partial class QueueList : IPagination, IEquatable<QueueList>, IValidatableObject
    {
        /// <summary>
        ...
        public QueueList(int? total = default(int?), int? start = default(int?), int? end = default(int?), int? page = default(int?), int? numPages = default(int?), int? pageSize = default(int?), string nextPageUri = default(string), List<QueueResult> queues = default(List<QueueResult>))
        {
            this.Total = total;
            this.Start = start;
            this.End = end;
        ...
        /// Gets or Sets Queues
        /// </summary>
        [DataMember(Name = "queues", EmitDefaultValue = true)]
        public List<QueueResult> Queues { get; set; }
        ...
        /// <summary>
        /// Retrieve the KVP Dictionary for the QueueList instance. 
        /// </summary>
        ...
        {
            return this.Equals(input as QueueList);
        }

        /// <summary>
        /// Returns true if QueueList instances are equal
        /// </summary>
        /// <param name="input">Instance of QueueList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueList input)
        {
            if (input == null)
            {
                return false;

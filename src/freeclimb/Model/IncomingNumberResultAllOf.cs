...
namespace freeclimb.Model
{
    ...
    public partial class IncomingNumberResultAllOf : IEquatable<IncomingNumberResultAllOf>, IValidatableObject
    {
        ...
        public IncomingNumberResultAllOf(Capabilities capabilities = default(Capabilities), string campaignId = default(string), SmsProviderEnum? smsProvider = default(SmsProviderEnum?), string phoneNumberId = default(string), string accountId = default(string), string applicationId = default(string), string phoneNumber = default(string), string alias = default(string), string region = default(string), string country = default(string), bool? voiceEnabled = default(bool?), bool? smsEnabled = default(bool?))
        {

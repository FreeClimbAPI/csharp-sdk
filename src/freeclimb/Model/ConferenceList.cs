...
namespace freeclimb.Model
{
    ...
    public partial class ConferenceList : IPagination, IEquatable<ConferenceList>, IValidatableObject
    {
        /// <summary>
        ...
        public ConferenceList(int? total = default(int?), int? start = default(int?), int? end = default(int?), int? page = default(int?), int? numPages = default(int?), int? pageSize = default(int?), string nextPageUri = default(string), List<ConferenceResult> conferences = default(List<ConferenceResult>))
        {
            this.Total = total;
            this.Start = start;
            this.End = end;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConferenceList {\n");
        ...
        /// <summary>
        /// Retrieve the KVP Dictionary for the ConferenceList instance. 
        /// </summary>
        ...
        {
            return this.Equals(input as ConferenceList);
        }

        /// <summary>
        /// Returns true if ConferenceList instances are equal
        /// </summary>
        /// <param name="input">Instance of ConferenceList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConferenceList input)
        {
            if (input == null)
            {
                return false;

...
namespace freeclimb.Model
{
    ...
    public partial class ConferenceList : IValidatableObject, IPagination
    {
        ...
        public ConferenceList(
            ...
            List<ConferenceResult> conferences = default(List<ConferenceResult>)
        )
        {
            this.Total = total;
        ...
        public virtual IDictionary<string, object> ToKvp()
        {
            ...
            List<object> nestedConferences = new List<object>();
            if (Conferences != null)
            {
                foreach (var item in Conferences)
                {
                    nestedConferences.Add(item.ToKvp());
                }
            }
            AddToDictionary(props, "conferences", nestedConferences);
            return props;
        }

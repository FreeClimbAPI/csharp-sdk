...
namespace freeclimb.Model
{
    ...
    /// BlobListResponse
    /// </summary>
    [DataContract(Name = "BlobListResponse")]
    public partial class BlobListResponse : IValidatableObject, IPagination
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BlobListResponse" /> class.
        /// </summary>
        ...
        public BlobListResponse(
            ...
            List<BlobResult> blobs = default(List<BlobResult>)
        )
        {
            this.Total = total;
        ...
        public List<BlobResult> Blobs { get; set; }
        ...
        /// <summary>
        /// Retrieve the KVP Dictionary for the BlobListResponse instance.
        /// </summary>
        ...
        public virtual IDictionary<string, object> ToKvp()
        {
            ...
            List<object> nestedBlobs = new List<object>();
            if (Blobs != null)
            {
                foreach (var item in Blobs)
                {
                    nestedBlobs.Add(item.ToKvp());
                }
            }
            AddToDictionary(props, "blobs", nestedBlobs);
            return props;
        }

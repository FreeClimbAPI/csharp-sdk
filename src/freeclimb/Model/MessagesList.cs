...
namespace freeclimb.Model
{
    ...
    public partial class MessagesList : IValidatableObject, IPagination
    {
        ...
        public MessagesList(
            ...
            List<MessageResult> messages = default(List<MessageResult>)
        )
        {
            this.Total = total;
        ...
        /// <summary>
        /// Retrieve the KVP Dictionary for the MessagesList instance.
        /// </summary>
        ...
        public virtual IDictionary<string, object> ToKvp()
        {
            ...
            List<object> nestedMessages = new List<object>();
            if (Messages != null)
            {
                foreach (var item in Messages)
                {
                    nestedMessages.Add(item.ToKvp());
                }
            }
            AddToDictionary(props, "messages", nestedMessages);
            return props;
        }

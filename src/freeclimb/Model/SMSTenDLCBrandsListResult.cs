...
namespace freeclimb.Model
{
    ...
    public partial class SMSTenDLCBrandsListResult : IEquatable<SMSTenDLCBrandsListResult>, IValidatableObject
    {
        /// <summary>
        ...
        public SMSTenDLCBrandsListResult(int? total = default(int?), int? start = default(int?), int? end = default(int?), int? page = default(int?), int? numPages = default(int?), int? pageSize = default(int?), string nextPageUri = default(string), List<SMSTenDLCBrand> queueMembers = default(List<SMSTenDLCBrand>))
        {
            this.Total = total;
            this.Start = start;
            this.End = end;
        ...
        public List<SMSTenDLCBrand> QueueMembers { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SMSTenDLCBrandsListResult {\n");
        ...
        /// <summary>
        /// Retrieve the KVP Dictionary for the SMSTenDLCBrandsListResult instance. 
        /// </summary>
        ...
        {
            return this.Equals(input as SMSTenDLCBrandsListResult);
        }

        /// <summary>
        /// Returns true if SMSTenDLCBrandsListResult instances are equal
        /// </summary>
        /// <param name="input">Instance of SMSTenDLCBrandsListResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SMSTenDLCBrandsListResult input)
        {
            if (input == null)
            {
                return false;

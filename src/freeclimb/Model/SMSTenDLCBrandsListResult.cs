...
namespace freeclimb.Model
{
    ...
    public partial class SMSTenDLCBrandsListResult : IValidatableObject, IPagination
    {
        ...
        public SMSTenDLCBrandsListResult(
            ...
            List<SMSTenDLCBrand> brands = default(List<SMSTenDLCBrand>)
        )
        {
            this.Total = total;
        ...
        public virtual IDictionary<string, object> ToKvp()
        {
            ...
            List<object> nestedBrands = new List<object>();
            if (Brands != null)
            {
                foreach (var item in Brands)
                {
                    nestedBrands.Add(item.ToKvp());
                }
            }
            AddToDictionary(props, "brands", nestedBrands);
            return props;
        }

...
namespace freeclimb.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SMSTenDLCCampaignsListResult_allOf")]
    public partial class SMSTenDLCCampaignsListResultAllOf : IEquatable<SMSTenDLCCampaignsListResultAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Retrieve the KVP Dictionary for the SMSTenDLCCampaignsListResultAllOf instance. 
        /// </summary>
        ...
        {
            return this.Equals(input as SMSTenDLCCampaignsListResultAllOf);
        }

        /// <summary>
        /// Returns true if SMSTenDLCCampaignsListResultAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of SMSTenDLCCampaignsListResultAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SMSTenDLCCampaignsListResultAllOf input)
        {
            if (input == null)
            {
                return false;

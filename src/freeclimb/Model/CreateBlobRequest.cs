...
namespace freeclimb.Model
{
    ...
    /// CreateBlobRequest
    /// </summary>
    [DataContract(Name = "CreateBlobRequest")]
    public partial class CreateBlobRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateBlobRequest" /> class.
        /// </summary>
        ...
        /// <param name="expiresAt">An RFC3339 timestamp with millisecond resolution. This timestamp defines the time at which this blob will delete itself. It must not be more than 48 hours in the future and will default to 9 hours in the future if not provided..</param>
        ...
        )
        {
            ...
            if (blob == null)
            {
                throw new ArgumentNullException(
                    "blob is a required property for CreateBlobRequest and cannot be null"
                );
            }
            this.Blob = blob;
        ...
        /// </summary>
        /// <value>An RFC3339 timestamp with millisecond resolution. This timestamp defines the time at which this blob will delete itself. It must not be more than 48 hours in the future and will default to 9 hours in the future if not provided.</value>
        /*
        <example>2006-01-02T15:04:05.000Z</example>
        */
        ...
        /// <summary>
        /// Retrieve the KVP Dictionary for the CreateBlobRequest instance.
        /// </summary>

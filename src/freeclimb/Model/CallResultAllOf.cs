...
namespace freeclimb.Model
{
    ...
    public partial class CallResultAllOf : IEquatable<CallResultAllOf>, IValidatableObject
    {
        ...
        public CallResultAllOf(string callId = default(string), string parentCallId = default(string), string accountId = default(string), string from = default(string), string to = default(string), string phoneNumberId = default(string), StatusEnum? status = default(StatusEnum?), string startTime = default(string), string connectTime = default(string), string endTime = default(string), int? duration = default(int?), int? connectDuration = default(int?), string direction = default(string), string answeredBy = default(string), Object subresourceUris = default(Object))
        {
            this.CallId = callId;

...
namespace freeclimb.Model
{
    ...
    {
        /// <summary>
        /// Provider to which the message was sent
        /// </summary>
        /// <value>Provider to which the message was sent</value>
        ...
        /// </summary>
        /// <value>Provider to which the message was sent</value>
        [DataMember(Name = "smsProvider", EmitDefaultValue = true)]
        public SmsProviderEnum? SmsProvider { get; set; }
        /// <summary>
        ...
        /// <param name="smsProvider">Provider to which the message was sent.</param>
        ...
        public IncomingNumberResult(string uri = default(string), string dateCreated = default(string), string dateUpdated = default(string), int revision = default(int), Capabilities capabilities = default(Capabilities), string campaignId = default(string), SmsProviderEnum? smsProvider = default(SmsProviderEnum?), string phoneNumberId = default(string), string accountId = default(string), string applicationId = default(string), string phoneNumber = default(string), string alias = default(string), string region = default(string), string country = default(string), bool? voiceEnabled = default(bool?), bool? smsEnabled = default(bool?))
        {
            this.Uri = uri;
        ...
        public bool Equals(IncomingNumberResult input)
        {
            ...
            return 
                ...
                (
                    this.SmsProvider == input.SmsProvider ||
                    this.SmsProvider.Equals(input.SmsProvider)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.SmsProvider.GetHashCode();

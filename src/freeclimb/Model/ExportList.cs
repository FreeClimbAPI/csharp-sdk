...
namespace freeclimb.Model
{
    ...
    /// ExportList
    /// </summary>
    [DataContract(Name = "ExportList")]
    public partial class ExportList : IValidatableObject, IPagination
    {
        /// <summary>
        ...
        public ExportList(
            ...
            List<ExportResult> exports = default(List<ExportResult>)
        )
        {
            this.Total = total;
        ...
        public List<ExportResult> Exports { get; set; }
        ...
        /// <summary>
        /// Retrieve the KVP Dictionary for the ExportList instance.
        /// </summary>
        ...
        public virtual IDictionary<string, object> ToKvp()
        {
            ...
            List<object> nestedExports = new List<object>();
            if (Exports != null)
            {
                foreach (var item in Exports)
                {
                    nestedExports.Add(item.ToKvp());
                }
            }
            AddToDictionary(props, "exports", nestedExports);
            return props;
        }

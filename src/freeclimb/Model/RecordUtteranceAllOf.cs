...
namespace freeclimb.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RecordUtterance_allOf")]
    public partial class RecordUtteranceAllOf : IEquatable<RecordUtteranceAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RecordUtteranceAllOf" /> class.
        /// </summary>
        ...
        public RecordUtteranceAllOf(string actionUrl = default(string), int silenceTimeoutMs = default(int), string finishOnKey = default(string), int maxLengthSec = default(int), bool playBeep = default(bool), bool autoStart = default(bool), bool privacyMode = default(bool))
        {
            // to ensure "actionUrl" is required (not null)
            if (actionUrl == null) {
                throw new ArgumentNullException("actionUrl is a required property for RecordUtteranceAllOf and cannot be null");
            }
        ...
        {
            return this.Equals(input as RecordUtteranceAllOf);
        }

        /// <summary>
        /// Returns true if RecordUtteranceAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of RecordUtteranceAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecordUtteranceAllOf input)
        {
            if (input == null)
            {
                return false;

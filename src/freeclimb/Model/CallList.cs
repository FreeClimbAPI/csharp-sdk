...
namespace freeclimb.Model
{
    ...
    public partial class CallList : IPagination, IEquatable<CallList>, IValidatableObject
    {
        /// <summary>
        ...
        public CallList(int? total = default(int?), int? start = default(int?), int? end = default(int?), int? page = default(int?), int? numPages = default(int?), int? pageSize = default(int?), string nextPageUri = default(string), List<CallResult> calls = default(List<CallResult>))
        {
            this.Total = total;
            this.Start = start;
            this.End = end;
        ...
        /// <summary>
        /// Retrieve the KVP Dictionary for the CallList instance. 
        /// </summary>
        ...
        {
            return this.Equals(input as CallList);
        }

        /// <summary>
        /// Returns true if CallList instances are equal
        /// </summary>
        /// <param name="input">Instance of CallList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallList input)
        {
            if (input == null)
            {
                return false;

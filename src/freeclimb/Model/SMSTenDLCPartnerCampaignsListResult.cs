...
namespace freeclimb.Model
{
    ...
    public partial class SMSTenDLCPartnerCampaignsListResult : IValidatableObject, IPagination
    {
        /// <summary>
        ...
        public SMSTenDLCPartnerCampaignsListResult(
            ...
            List<SMSTenDLCPartnerCampaign> partnerCampaigns =
                default(List<SMSTenDLCPartnerCampaign>)
        )
        {
            this.Total = total;
        ...
        public virtual IDictionary<string, object> ToKvp()
        {
            ...
            List<object> nestedPartnerCampaigns = new List<object>();
            if (PartnerCampaigns != null)
            {
                foreach (var item in PartnerCampaigns)
                {
                    nestedPartnerCampaigns.Add(item.ToKvp());
                }
            }
            AddToDictionary(props, "partnerCampaigns", nestedPartnerCampaigns);
            return props;
        }

...
namespace freeclimb.Model
{
    ...
    public partial class SMSTenDLCPartnerCampaignsListResult : IEquatable<SMSTenDLCPartnerCampaignsListResult>, IValidatableObject
    {
        ...
        /// <summary>
        /// Retrieve the KVP Dictionary for the SMSTenDLCPartnerCampaignsListResult instance. 
        /// </summary>
        ...
        {
            return this.Equals(input as SMSTenDLCPartnerCampaignsListResult);
        }

        /// <summary>
        /// Returns true if SMSTenDLCPartnerCampaignsListResult instances are equal
        /// </summary>
        /// <param name="input">Instance of SMSTenDLCPartnerCampaignsListResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SMSTenDLCPartnerCampaignsListResult input)
        {
            if (input == null)
            {
                return false;

...
namespace freeclimb.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IncomingNumberList_allOf")]
    public partial class IncomingNumberListAllOf : IEquatable<IncomingNumberListAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IncomingNumberListAllOf" /> class.
        /// </summary>
        /// <param name="incomingPhoneNumbers">incomingPhoneNumbers.</param>
        public IncomingNumberListAllOf(List<IncomingNumberResult> incomingPhoneNumbers = default(List<IncomingNumberResult>))
        {
        ...
        {
            return this.Equals(input as IncomingNumberListAllOf);
        }

        /// <summary>
        /// Returns true if IncomingNumberListAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of IncomingNumberListAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IncomingNumberListAllOf input)
        {
            if (input == null)
            {
                return false;

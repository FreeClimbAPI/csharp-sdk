...
namespace freeclimb.Model
{
    ...
    /// QueueMemberList
    /// </summary>
    [DataContract(Name = "QueueMemberList")]
    public partial class QueueMemberList : IPagination, IEquatable<QueueMemberList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueMemberList" /> class.
        /// </summary>
        ...
        public QueueMemberList(int? total = default(int?), int? start = default(int?), int? end = default(int?), int? page = default(int?), int? numPages = default(int?), int? pageSize = default(int?), string nextPageUri = default(string), List<QueueMember> queueMembers = default(List<QueueMember>))
        {
            this.Total = total;
            this.Start = start;
            this.End = end;
        ...
        {
            return this.Equals(input as QueueMemberList);
        }

        /// <summary>
        /// Returns true if QueueMemberList instances are equal
        /// </summary>
        /// <param name="input">Instance of QueueMemberList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueMemberList input)
        {
            if (input == null)
            {
                return false;

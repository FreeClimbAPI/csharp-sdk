...
namespace freeclimb.Model
{
    ...
    public partial class ConferenceResult : IEquatable<ConferenceResult>, IValidatableObject
    {
        ...
        public ConferenceResult(string uri = default(string), string dateCreated = default(string), string dateUpdated = default(string), int revision = default(int), string conferenceId = default(string), string accountId = default(string), string alias = default(string), PlayBeepEnum? playBeep = default(PlayBeepEnum?), bool? record = default(bool?), StatusEnum? status = default(StatusEnum?), string waitUrl = default(string), string actionUrl = default(string), string statusCallbackUrl = default(string), Object subresourceUris = default(Object))
        {
            this.Uri = uri;

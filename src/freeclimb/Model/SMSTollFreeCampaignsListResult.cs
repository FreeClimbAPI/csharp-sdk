...
namespace freeclimb.Model
{
    ...
    public partial class SMSTollFreeCampaignsListResult : IPagination, IEquatable<SMSTollFreeCampaignsListResult>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as SMSTollFreeCampaignsListResult);
        }

        /// <summary>
        /// Returns true if SMSTollFreeCampaignsListResult instances are equal
        /// </summary>
        /// <param name="input">Instance of SMSTollFreeCampaignsListResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SMSTollFreeCampaignsListResult input)
        {
            if (input == null)
            {
                return false;

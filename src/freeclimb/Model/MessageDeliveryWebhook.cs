...
namespace freeclimb.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MessageDeliveryWebhook")]
    [JsonConverter(typeof(JsonSubtypes), "RequestType")]
    public partial class MessageDeliveryWebhook : Webhook, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageDeliveryWebhook" /> class.
        /// </summary>
        /// <param name="requestType">Value will be messageDelivery - An SMS message has been received by the platform and is being delivered to the customer application associated with the destination number. (default to &quot;MessageDeliveryWebhook&quot;).</param>
        ...
        /// <param name="direction">Value will be inbound to indicate the receipt of a message into the FreeClimb platform..</param>
        /// <param name="applicationId">ID of the application to which the destination number is assigned..</param>
        ...
        {
            return JsonConvert.DeserializeObject(jsonPayload, typeof(MessageDeliveryWebhook), this._serializerSettings);
        }
        ...
        /// </summary>
        /// <value>Value will be inbound to indicate the receipt of a message into the FreeClimb platform.</value>
        ...
        /// </summary>
        /// <value>Value will be received to indicate that the platform has successfully received the incoming message.</value>

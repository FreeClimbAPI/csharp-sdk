    ...
    public partial class SMSTenDLCBrand : IValidatableObject
    {
        ...
        */
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for Ein, length must be less than 21.", new [] { "Ein" });
            }

            // EinIssuingCountry (string) maxLength
            if (this.EinIssuingCountry != null && this.EinIssuingCountry.Length > 2)
            {
                yield return new ValidationResult("Invalid value for EinIssuingCountry, length must be less than 2.", new [] { "EinIssuingCountry" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for Street, length must be less than 100.", new [] { "Street" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for StockSymbol, length must be less than 10.", new [] { "StockSymbol" });
            }

            // IpAddress (string) maxLength
            if (this.IpAddress != null && this.IpAddress.Length > 50)
            {
                yield return new ValidationResult("Invalid value for IpAddress, length must be less than 50.", new [] { "IpAddress" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for Vertical, length must be less than 50.", new [] { "Vertical" });
            }

            // AltBusinessId (string) maxLength
            if (this.AltBusinessId != null && this.AltBusinessId.Length > 50)
            {
                yield return new ValidationResult("Invalid value for AltBusinessId, length must be less than 50.", new [] { "AltBusinessId" });
            }

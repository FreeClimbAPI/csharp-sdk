...
namespace freeclimb.Model
{
    ...
    public partial class RecordingList : IPagination, IEquatable<RecordingList>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as RecordingList);
        }

        /// <summary>
        /// Returns true if RecordingList instances are equal
        /// </summary>
        /// <param name="input">Instance of RecordingList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecordingList input)
        {
            if (input == null)
            {
                return false;

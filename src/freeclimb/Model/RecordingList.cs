...
namespace freeclimb.Model
{
    ...
    public partial class RecordingList : IValidatableObject, IPagination
    {
        ...
        public RecordingList(
            ...
            List<RecordingResult> recordings = default(List<RecordingResult>)
        )
        {
            this.Total = total;
        ...
        public virtual IDictionary<string, object> ToKvp()
        {
            ...
            List<object> nestedRecordings = new List<object>();
            if (Recordings != null)
            {
                foreach (var item in Recordings)
                {
                    nestedRecordings.Add(item.ToKvp());
                }
            }
            AddToDictionary(props, "recordings", nestedRecordings);
            return props;
        }

...
namespace freeclimb.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AudioStreamWebhook")]
    [JsonConverter(typeof(JsonSubtypes), "RequestType")]
    public partial class AudioStreamWebhook : Webhook, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AudioStreamWebhook" /> class.
        /// </summary>
        /// <param name="requestType">Context or reason why this request is being made. Will be audioStream - gRPC session for this Call has ended and its actionUrl is being invoked. (default to &quot;AudioStreamWebhook&quot;).</param>
        /// <param name="callId">Unique ID for this Call, generated by FreeClimb. This is the call leg which ended its gRPC session..</param>
        ...
        public AudioStreamWebhook(
            string requestType = @"AudioStreamWebhook",
        ...
        /// <summary>
        /// Deserializes json payload into instance AudioStreamWebhook
        /// </summary>
        /// <param name="jsonPayload"></param>
        /// <returns>instanceof RemoveFromQueueNotificationWebhook</returns>
        public static AudioStreamWebhook Deserialize(string jsonPayload)
        {
            return (AudioStreamWebhook)
                JsonConvert.DeserializeObject(
                    jsonPayload,
                    typeof(AudioStreamWebhook),
                    _serializerSettings
                );
        }
        ...
        /// </summary>
        /// <value>Unique ID for this Call, generated by FreeClimb. This is the call leg which ended its gRPC session.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AudioStreamWebhook {\n");
        ...
        /// <summary>
        /// Retrieve the KVP Dictionary for the AudioStreamWebhook instance.
        /// </summary>

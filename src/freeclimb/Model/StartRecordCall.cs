...
namespace freeclimb.Model
{
    ...
    public partial class StartRecordCall : PerclCommand, IEquatable<StartRecordCall>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as StartRecordCall);
        }

        /// <summary>
        /// Returns true if StartRecordCall instances are equal
        /// </summary>
        /// <param name="input">Instance of StartRecordCall to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StartRecordCall input)
        {
            if (input == null)
            {
                return false;

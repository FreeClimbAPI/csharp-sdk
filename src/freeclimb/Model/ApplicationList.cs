...
namespace freeclimb.Model
{
    ...
    public partial class ApplicationList : IValidatableObject, IPagination
    {
        ...
        public ApplicationList(
            ...
            List<ApplicationResult> applications = default(List<ApplicationResult>)
        )
        {
            this.Total = total;
        ...
        public virtual IDictionary<string, object> ToKvp()
        {
            ...
            List<object> nestedApplications = new List<object>();
            if (Applications != null)
            {
                foreach (var item in Applications)
                {
                    nestedApplications.Add(item.ToKvp());
                }
            }
            AddToDictionary(props, "applications", nestedApplications);
            return props;
        }

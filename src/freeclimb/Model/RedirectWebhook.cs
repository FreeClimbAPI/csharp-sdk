...
namespace freeclimb.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RedirectWebhook")]
    [JsonConverter(typeof(JsonSubtypes), "RequestType")]
    public partial class RedirectWebhook : Webhook, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RedirectWebhook" /> class.
        /// </summary>
        /// <param name="requestType">Context or reason why this request is being made. Will be redirect - The Redirect command is executing and its actionUrl is being invoked. (default to &quot;RedirectWebhook&quot;).</param>
        ...
        {
            return JsonConvert.DeserializeObject(jsonPayload, typeof(RedirectWebhook), this._serializerSettings);
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RedirectWebhook {\n");
        ...
        /// <summary>
        /// Retrieve the KVP Dictionary for the RedirectWebhook instance. 
        /// </summary>

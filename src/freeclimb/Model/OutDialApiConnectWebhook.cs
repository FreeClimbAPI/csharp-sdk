...
namespace freeclimb.Model
{
    ...
    public partial class OutDialApiConnectWebhook : Webhook, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Context or reason why this request is being made. Will be outDialApiConnect - An outbound call spawned by the REST API has connected and the callConnectUrl specified in the API request is being invoked.</value>

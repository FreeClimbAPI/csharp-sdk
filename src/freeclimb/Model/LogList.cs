...
namespace freeclimb.Model
{
    ...
    public partial class LogList : IPagination, IEquatable<LogList>, IValidatableObject
    {
        /// <summary>
        ...
        public LogList(int? total = default(int?), int? start = default(int?), int? end = default(int?), int? page = default(int?), int? numPages = default(int?), int? pageSize = default(int?), string nextPageUri = default(string), List<LogResult> logs = default(List<LogResult>))
        {
            this.Total = total;
            this.Start = start;
            this.End = end;

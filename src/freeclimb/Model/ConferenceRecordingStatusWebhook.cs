...
namespace freeclimb.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConferenceRecordingStatusWebhook")]
    [JsonConverter(typeof(JsonSubtypes), "RequestType")]
    public partial class ConferenceRecordingStatusWebhook : Webhook, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConferenceRecordingStatusWebhook" /> class.
        /// </summary>
        /// <param name="requestType">Context or reason why this request is being made. Will be conferenceRecordingStatus - The statusCallbackUrl request includes Recording information for a Conference that ended. (default to &quot;ConferenceRecordingStatusWebhook&quot;).</param>
        ...
        /// <summary>
        /// Deserializes json payload into instance ConferenceRecordingStatusWebhook
        /// </summary>
        /// <param name="jsonPayload"></param>
        /// <returns>instanceof RemoveFromQueueNotificationWebhook</returns>
        public static ConferenceRecordingStatusWebhook Deserialize(string jsonPayload)
        {
            return (ConferenceRecordingStatusWebhook)JsonConvert.DeserializeObject(jsonPayload, typeof(ConferenceRecordingStatusWebhook), _serializerSettings);
        }
        ...
        /// </summary>
        /// <value>URL of the Conference’s recorded audio. Populated only if a Recording exists and the Conference was emptied.</value>
        ...
        /// </summary>
        /// <value>Unique ID of the Recording from this Conference. Populated only if a recording exists and the Conference was emptied.</value>
        ...
        /// </summary>
        /// <value>Duration of the recorded audio (in seconds), rounded up to the nearest second. Populated only if a Recording exists and the Conference was emptied.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConferenceRecordingStatusWebhook {\n");
        ...
        /// <summary>
        /// Retrieve the KVP Dictionary for the ConferenceRecordingStatusWebhook instance. 
        /// </summary>

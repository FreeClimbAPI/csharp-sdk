...
namespace freeclimb.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SayStandard")]
    public partial class SayStandard : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SayStandard" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SayStandard() { }
        ...
        )
        {
            ...
            if (text == null)
            {
                throw new ArgumentNullException(
                    "text is a required property for SayStandard and cannot be null"
                );
            }
            this.Text = text;
            ...
            {
                throw new ArgumentNullException(
                    "engine is a required property for SayStandard and cannot be null"
                );
            }
            this.Engine = engine;
        ...
        /// <summary>
        /// Retrieve the KVP Dictionary for the SayStandard instance.
        /// </summary>

...
namespace freeclimb.Model
{
    ...
    public partial class MessageRequestAllOf : IEquatable<MessageRequestAllOf>, IValidatableObject
    {
        ...
        public MessageRequestAllOf(string from = default(string), string to = default(string), string text = default(string), string notificationUrl = default(string), List<string> mediaUrls = default(List<string>))
        {

...
namespace freeclimb.Api
{
    ...
    public interface IDefaultApiSync : IApiAccessor
    {
        ...
        /// <param name="hasApplication">Only show calls which are associated with an Application (applicationId !&#x3D; null) (optional)</param>
        /// <returns>CallList</returns>
        CallList ListCalls(bool? active = default(bool?), string to = default(string), string from = default(string), CallStatus? status = default(CallStatus?), string startTime = default(string), string endTime = default(string), string parentCallId = default(string), List<string> applicationId = default(List<string>), bool? hasApplication = default(bool?));
    ...
    public interface IDefaultApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<CallList> ListCallsAsync(bool? active = default(bool?), string to = default(string), string from = default(string), CallStatus? status = default(CallStatus?), string startTime = default(string), string endTime = default(string), string parentCallId = default(string), List<string> applicationId = default(List<string>), bool? hasApplication = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class DefaultApi : IDefaultApi
    {
        ...
        {
            freeclimb.Client.ApiResponse<CallList> localVarResponse = ListCallsWithHttpInfo(active , to , from , status , startTime , endTime , parentCallId , applicationId , hasApplication );
            return localVarResponse.Data;
        }
        ...
        {
            freeclimb.Client.ApiResponse<CallList> localVarResponse = await ListCallsWithHttpInfoAsync(active, to, from, status, startTime, endTime, parentCallId, applicationId, hasApplication, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }

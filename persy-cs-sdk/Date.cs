...
namespace com.persephony
{
    ...
    public struct Date : IComparable, IFormattable, ISerializable, IComparable<Date>, IEquatable<Date>
    {
        ...
        /// <exception cref="PersyDateException">Thrown upon failed request.</exception>
        public Date(int year, int month, int day)
        {
            ...
            {
                throw new PersyDateException(year, month, day);
            }
        }
        ...
        public Date(DateTime dateTime)
        {
            ...
            {
                throw new PersyDateException(((dateTime != null) ? dateTime.ToLongTimeString() : "Null"));
            }
        }

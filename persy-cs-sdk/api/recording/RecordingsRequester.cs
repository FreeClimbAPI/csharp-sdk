...
namespace com.persephony.api.recording
{
    ...
    public sealed class RecordingsRequester : APIRequester
    {
        ...
        public RecordingList getMeta(RecordingsSearchFilters filters = null)
        {
            ...
            {
                throw new PersyException("Failed to get recording list information");
            }
        ...
        /// <summary>
        /// Retrieve a single recording meta data from Persephony.
        /// </summary>
        ...
        public Recording getMetaByRecordingId(string recordingId)
        {
            ...
            if (string.IsNullOrEmpty(json) == true)
            {
                throw new PersyException(String.Format("Failed to get recording {0} information", recordingId ?? ""));
            }
        ...
        /// <summary>
        /// Retrieve a single recording from Persephony.
        /// </summary>
        ...
        public byte[] download(string recordingId)
        {
            ...
            {
                throw new PersyException(String.Format("Failed to download recording {0}", recordingId ?? ""));
            }
        ...
        /// <summary>
        /// Stream a single recording from Persephony.
        /// </summary>
        /// <param name="recordingId">The recordingId of the target recording.</param>
        ...
        public Stream stream(string recordingId)
        {
            ...
            if (stream == null)
            {
                throw new PersyException(String.Format("Failed to get recording {0} stream", recordingId ?? ""));
            }
        ...
        /// <summary>
        /// Delete a Persephony recording and its associated meta data.
        /// </summary>
